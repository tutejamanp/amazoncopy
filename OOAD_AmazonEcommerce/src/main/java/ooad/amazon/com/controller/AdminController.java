...
public class AdminController {
	...
	public List<Product> displayprodseller(@PathParam("id") int id){
		List<Product> lproduct =AdminDAO.displayprodseller(id);
		return lproduct;
	}
	...
	@Path("/addrdetails/{id}")
	@Produces(MediaType.APPLICATION_JSON)
	public List<Address> addrdetails(@PathParam("id") int id){
		List<Address> addresslist =AdminDAO.addressdetails(id);
		return addresslist;
	...
	public List<Product> displayproducts(){
		List<Product> lproducts =AdminDAO.displayproducts();
		return lproducts;
