...
public class AdvertismentController {
	...
	public Response addAdvert(@FormDataParam("addImageSelect") InputStream file,
		...
		//System.out.println("\nProduct Name: " + name + "\nCategory: " + category + "\nBirthday: " + bday);
 		...
 		String uploadedFileLocation = "C:\\Users\\Manpreet\\Downloads\\finalooad-master\\finalooad-master\\OOAD_AmazonEcommerce\\src\\main\\webapp\\images\\advertisments\\" + productname + "." +  fileDetail.getFileName().split("\\.")[1];
