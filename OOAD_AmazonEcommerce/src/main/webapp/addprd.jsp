...
<article class="card-body col-md-10 offset-md-1" >
	...
	<div class="form-group">
				...
				<a href="updateprd.jsp" class="widget-header">
					 <button type="button" name="updateproduct" class="btn btn-warning btn-block" id ="updateproduct"> Go to Update Product </button>
				</a>
