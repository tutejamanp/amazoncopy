...
<script src="js/scripts/yourbill.js" type="text/javascript"></script>
...
<tr>
  ...
  <th scope="col" width="120">Item id</th>
...
<h3>TOTAL VALUE : </h3>
<output class="form-control" name="total_value" id="total_value"> </output>
<br>

<h3>VAT :</h3>
<output class="form-control" name="vat" id="vat" > </output>
</div> <!-- card.// -->
<div class="form-group">
        <a href="home.jsp"><button type="submit" class="btn btn-warning btn-block" > Home </button></a>
    </div>   
